            ...
            <div class="col-md-8">
                <!-- post-container -->
                 <?php   
                     ...
                     $Query = mysqli_query($con,"select * from post join user on post.author = user.user_id 
                        where 
                        post.author='".$auth_id."'")or die("Query Error for author ");
                        $res=mysqli_fetch_assoc($Query);
                    ?>
                  <h2 class="page-heading"><?php echo $res['username'];?></h2>
                     <?php
                         include"config.php";
                             if (isset($_GET['aid'])) {
                                $auth_id=$_GET['aid'];
                   ...
                   /*  Offset Value Count Pagination*/
                         $sql=mysqli_query($con,"select post.post_id,post.title,post.author,
                           ...
                           post.author = user.user_id where post.author='{$auth_id}' 
                      ...
                      ?>                        
                        ...
                        <?php
                          ...
                          /*  Pagination Start*/   
                        //$Query = mysqli_query($con,"select * from category where category_id='".$."'")or die("Query Error");
